...
public class SalesForceClass extends ProjectSpecificMethod {

        @DataProvider(name = "LeadDetails")
        public String[][] SendData() {
                String[][] data = new String[2][2];
                data[0][1] = "Salesforce Automation By Karthick";
                data[0][2] = "Salesforce";

                data[1][2] = "Salesforce Automation by Prabu";
                data[1][2] = "Salesforce1";
                return data;

        }

        @Test(dataProvider = "LeadDetails")
        public void legalEntity(String entityName, String description) throws InterruptedException
